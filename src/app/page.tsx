        ...
        <section id="about" className="mb-16">
          ...
          <div className="bg-white dark:bg-slate-800 p-8 rounded-xl shadow-lg max-w-4xl mx-auto">
            <p className="text-lg text-slate-600 dark:text-slate-300 mb-6">
              Hello! I&apos;m Abu Amar, a passionate software developer with a love for creating innovative digital solutions. 
              I specialize in modern web technologies and enjoy turning complex problems into simple, beautiful designs.
            </p>
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
            {[
              ...
              'Python', 'JavaScript', 'Tailwind CSS', 'Git'
            ].map((skill) => (
              <div key={skill} className="bg-white dark:bg-slate-800 p-4 rounded-lg shadow-md text-center">
